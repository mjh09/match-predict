...
from pages import index, predictions, results, process
...
navbar = dbc.NavbarSimple(
    brand='SC2 Match Predicting',
    brand_href='/', 
    children=[
        dbc.NavItem(dcc.Link('Predictions', href='/predictions', className='nav-link')), 
        dbc.NavItem(dcc.Link('Process', href='/process', className='nav-link')), 
        dbc.NavItem(dcc.Link('Results', href='/results', className='nav-link')), 
    ],
    sticky='top',
    color='dark', 
    dark=True,
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Matthew Harshman', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:matthewharshman66@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/mjh09/match-predict'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/matthew-harshman-841584188/'), 
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/'), 
                ], 
                className='lead'
            )
        )
